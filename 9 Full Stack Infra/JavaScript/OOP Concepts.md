...
## Evolution of OOP in JavaScript

### Pre-ES6 (Old Version)

JavaScript originally used constructor functions and prototypes to implement OOP.
...
ES6 introduced classes, which are syntactic sugar over constructor functions and prototypes.
...
- Constructor Functions → Object creation pattern   
- Prototypes → Method sharing mechanism  
- Classes → Cleaner syntax over both  
- Classes internally use prototypes (syntactic sugar)  

→ For detailed explanation: [[Classes]]  
→ For prototype behavior: [[Prototypes]]
...
%% what is the use of this if we are not using this keyword  %%
#### Output
